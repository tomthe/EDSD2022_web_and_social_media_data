...
There are a number of tweet-data dumps somewhere in the internet with vastly different content. At the MPIDR we have a "1% sample" which contains 1 % of all tweets from 2012 to April 2018 with 20 to 50 GB per month = 2.6TB in total. ~~But I was not able to find it online (if you want to work with it, you could get access through the MPIDR).~~ You can download this sample from the Internet Archive: https://archive.org/details/twitterstream
...
**Exercise 2.4:** Download more Data just like you did in exercise 2.2 and convert it to the following format and save it as a csv-file (use the [countrycode package](https://github.com/vincentarelbundock/countrycode) to convert the country names to country codes, if you need to):
