...
* INED - https://www.wikidata.org/wiki/Q3152388


But it is not easy to handle the full dump in R. I was not able to decompress it partially, which is possible to do in Python. An start could be the library [qwikidata](https://github.com/kensho-technologies/qwikidata).
...
This data is unfortunately not available anymore. It is now closed data. We have a partial
copy at the MPIDR. Google [pays 60 Million $](https://www.reuters.com/technology/reddit-ai-content-licensing-deal-with-google-sources-say-2024-02-22/) for it in 2024 to be able to use it to train AI models.

You might be able to find [some copies](https://wiki.archiveteam.org/index.php/Reddit)

(You can contact me if you want to work with this data or a subset thereof. I have worked with it before)

### Stack Overflow

[Stack Overflow](https://stackoverflow.com) is a question-answer site. Mostly for programmers and scientist.
The whole dump can be downloaded  and is about 40 GB compressed xml. It can also be accessed online here: https://data.stackexchange.com/stackoverflow/query/new
...
If you want to work with Twitter data and can not afford to pay 100k$ for API-access,
you might want to work with a Twitter-dump.

Twitter earns 10% of its revenue by selling data. But it offered a 1% sample for free.
This sample contains all tweets that are sent in the first 10 microseconds of every
second. This is still a huge number of tweets. Volunteers have gathered this sample
and offer it for free:

https://archive.org/details/twitterstream

Unfortunately, this is not updated anymore since mid-2021.
...
This is still a huge dataset that you can't process on your laptop. But there is a script that you can use to download, filter and process the data: https://github.com/fhamborg/news-please/blob/master/newsplease/examples/commoncrawl.py

https://commoncrawl.org/2016/10/news-dataset-available/ -  Many Terrabytes. Many duplicates. Not a project for one day.
